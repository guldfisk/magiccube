...
class TrapDistribution(Individual):
    ...
    def __init__(
        ...
        trap_amount: int = 1,
        nodes: t.Optional[t.List[t.List[ConstrainedNode]]] = None,
        ...
        if nodes is None:
            self.traps: t.List[t.List[ConstrainedNode]] = [[] for _ in range(trap_amount)]
            ...
            self.traps = nodes #type: t.List[t.List[ConstrainedNode]]
...
class Distributor(object):
    ...
    def trap_collection_to_trap_distribution(
        ...
        return TrapDistribution(nodes=distribution), added, removed
